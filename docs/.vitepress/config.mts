  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '论文笔记（按首次读完时间）',
        items: [
          { text: '2026-09-17 · V2U4Real：车和无人机协同感知', link: '/blog/2026-09-17-v2u4real-reading-notes' },
          { text: '2026-09-18 · TACO：LiDAR 定位与 3D 检测联合学习', link: '/blog/2026-09-18-taco-reading-notes' },
          { text: '2026-09-20 · MSGNav：多模态场景图与零样本导航', link: '/blog/2026-09-20-msgnav-reading-notes' }
        ]
      },
      {
        text: '博客',
